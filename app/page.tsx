                    ...
                    <div className="relative md:mt-24 mx-auto w-full max-w-4xl pt-4 text-center">
                        <div className="justify-center hidden md:flex">
                            <div
                                ...
                                <Badge className="font-semibold">Novo</Badge>
                                <h5>integração com nossos principais canais comunicação</h5>
                        ...
                        <h1 className="md:text-7xl my-4 font-extrabold text-4xl md:leading-tight">A solução inteligente para encontrar e gerenciar freelancers de confiança!</h1>
                        <p className="mx-auto my-4 text-sm w-full max-w-xl text-center font-medium leading-relaxed tracking-wide">
                        Somos uma startup emergente dedicada a conectar clientes com freelancers qualificados. No início de nossa jornada, estamos focados em construir uma plataforma confiável e eficiente para facilitar a gestão de talentos e impulsionar o sucesso dos nossos clientes.
                        </p>
                ...
                <div className="container mx-auto text-center">
                    <div className="my-24">
                        ...
                        <p className="mx-auto my-4 text-sm w-full max-w-md bg-transparent text-center font-medium leading-relaxed tracking-wide text-muted-foreground">
                            Nao perca mais tempo prospectando clientes, nós isso fazemos por voce.
                        </p>
            ...
            <section
                ...
                <div className="container mx-auto text-center">
                    <div className="py-14">
                        ...
                        <p className="mx-auto my-4 text-sm w-full max-w-md bg-transparent text-center font-medium leading-relaxed tracking-wide text-muted-foreground">
                        Escolha um plano que funcione melhor para você. Você sempre pode fazer upgrade ou downgrade do seu plano mais tarde.
                        </p>
